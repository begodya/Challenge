...
NSString *completeRPCURLPath = @"/bwwebviewprogressproxy/complete";

const float BWInitialProgressValue = 0.0f;
const float BWInteractiveProgressValue = 0.5f;
const float BWFinalProgressValue = 0.9f;


@implementation BWWebViewProgress {
...
- (void)startProgress {
    if (_progress < BWInitialProgressValue) {
        [self setProgress:BWInitialProgressValue];
    }
}

- (void)incrementProgress {
    float progress = self.progress;
    float maxProgress = _interactive ? BWFinalProgressValue : BWInteractiveProgressValue;
